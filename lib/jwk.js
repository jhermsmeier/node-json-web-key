...
JSONWebKey.fromPEM = function( pem ) {
  ...
  if( type === 'public' ) {
    webKey.n = bnToBuffer( pemData.n )
    webKey.e = bnToBuffer( pemData.e )
  } else {
    webKey.n = bnToBuffer( pemData.n )
    webKey.e = bnToBuffer( pemData.e )
    webKey.d = bnToBuffer( pemData.d )
    webKey.p = bnToBuffer( pemData.p )
    webKey.q = bnToBuffer( pemData.q )
    webKey.dp = bnToBuffer( pemData.dp )
    webKey.dq = bnToBuffer( pemData.dq )
    webKey.qi = bnToBuffer( pemData.qi )
  }
